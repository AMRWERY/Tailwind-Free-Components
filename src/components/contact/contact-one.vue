        ...
        <div class="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
            ...
            <form novalidate class="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                ...
                <label class="block">
                    ...
                    <textarea rows="3"
                        class="block w-full rounded-md focus:ring focus:ri focus:ri dark:bg-gray-800"></textarea>
                </label>
                <button type="button"
                    class="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ri dark:bg-violet-400 dark:text-gray-900 focus:ri hover:ri">Submit</button>
            </form>
        </div>
    </section>
</template>