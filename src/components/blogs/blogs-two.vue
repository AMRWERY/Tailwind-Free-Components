<template>
    <div class="max-w-sm w-full lg:max-w-full lg:flex">
        <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden"
            style="background-image: url('https://tecdn.b-cdn.net/img/Photos/Avatars/img%20(22).jpg')"
        ...
        <div
            ...
            <div class="flex items-center">
                <img class="w-10 h-10 rounded-full mr-4" src="https://tecdn.b-cdn.net/img/Photos/Avatars/img%20(19).jpg">
                <div class="text-sm">
