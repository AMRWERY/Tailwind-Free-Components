                ...
                <div class="bg-white shadow">
                    <div class="px-4 py-6 sm:px-8 sm:py-10">
                                ...
                                <li class="flex flex-col py-6 space-y-3 text-left  sm:flex-row sm:space-x-5 sm:space-y-0">
                                    ...
                                    <div class="relative flex flex-col justify-between flex-1">
                                            ...
                                            <div class="flex items-end justify-between mt-4  sm:mt-0 sm:items-start sm:justify-end">
                                                ...
                                                <div class="sm:order-1">
                                                    <div class="flex items-stretch h-8 mx-auto text-gray-600">
                                                        <button class="flex items-center justify-center px-4 transition bg-gray-200  rounded-l-md hover:bg-black hover:text-white">
                                                            -
                                                        </button>
                                                        <div class="flex items-center justify-center w-full px-4 text-xs uppercase transition bg-gray-100 ">
                                                            1
                                                        </div>
                                                        <button class="flex items-center justify-center px-4 transition bg-gray-200  rounded-r-md hover:bg-black hover:text-white">
                                                            +
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="absolute top-0 right-0 flex  sm:bottom-0 sm:top-auto">
                                            <button type="button" class="flex p-2 text-center text-gray-500 transition-all duration-200 ease-in-out rounded  focus:shadow hover:text-gray-900">
                        ...
                        <div class="mt-6 text-center">
                            <button type="button" class="inline-flex items-center justify-center w-full px-6 py-4 text-lg font-semibold text-white transition-all duration-200 ease-in-out bg-gray-900 rounded-md  group focus:shadow hover:bg-gray-800">
                                Checkout
