<template>
    <section class="h-screen py-12 bg-gray-100 sm:py-16 lg:py-20">
                ...
                <div class="bg-white shadow">
                    <div class="px-4 py-6 sm:px-8 sm:py-10">
                        <div class="flow-root">
                            <ul class="-my-8">
                                <li
                                    class="flex flex-col py-6 space-y-3 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                                    <div class="shrink-0">
                                    ...
                                    <div class="relative flex flex-col justify-between flex-1">
                                        <div class="sm:col-gap-5 sm:grid sm:grid-cols-2">
                                            ...
                                            <div
                                                class="flex items-end justify-between mt-4 sm:mt-0 sm:items-start sm:justify-end">
                                                <p
                                                    class="w-20 text-base font-semibold text-gray-900 shrink-0 sm:order-2 sm:ml-8 sm:text-right">
                                                    $259.00
                                                </p>
                                                ...
                                                <div class="sm:order-1">
                                                    <div class="flex items-stretch h-8 mx-auto text-gray-600">
                                                        <button
                                                            class="flex items-center justify-center px-4 transition bg-gray-200 rounded-l-md hover:bg-black hover:text-white">
                                                            -
                                                        </button>
                                                        <div
                                                        ...
                                                        <button
                                                            class="flex items-center justify-center px-4 transition bg-gray-200 rounded-r-md hover:bg-black hover:text-white">
                                                            +
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="absolute top-0 right-0 flex sm:bottom-0 sm:top-auto">
                                            <button type="button"
                                                class="flex p-2 text-center text-gray-500 transition-all duration-200 ease-in-out rounded focus:shadow hover:text-gray-900">
                                ...
                                <li
                                    ...
                                    <div class="relative flex flex-col justify-between flex-1">
                                        ...
                                        <div class="absolute top-0 right-0 flex sm:bottom-0 sm:top-auto">
                                            <button type="button"
                                                class="flex p-2 text-center text-gray-500 transition-all duration-200 ease-in-out rounded focus:shadow hover:text-gray-900">
                                                <svg class="block w-5 h-5" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="mt-6 text-center">
                            <button type="button"
                                class="inline-flex items-center justify-center w-full px-6 py-4 text-lg font-semibold text-white transition-all duration-200 ease-in-out bg-gray-900 rounded-md group focus:shadow hover:bg-gray-800">
                                Checkout
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="w-6 h-6 ml-4 transition-all group-hover:ml-8" fill="none" viewBox="0 0 24 24"
