<template>
    <div>
        <div class="max-w-4xl p-4 mx-auto font-sans max-md:max-w-xl">
                ...
                <div class="space-y-4 md:col-span-2">
                    ...
                    <div class="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(61,63,68,0.3)]">
                        <div class="flex gap-4">
                            ...
                            <div class="flex flex-col gap-4">
                                <div>
                                    <h3 class="text-sm font-bold text-gray-800 sm:text-base">Stylish Golden Watch</h3>
                                    <p class="flex items-center gap-2 mt-2 text-sm font-semibold text-gray-500">Color:
                                        <span class="inline-block w-5 h-5 rounded-md bg-[#ac7f48]"></span></p>
                                </div>
                        ...
                        <div class="flex flex-col ml-auto">
                            <div class="flex items-start justify-end gap-4">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="inline-block w-4 h-4 cursor-pointer fill-gray-400 hover:fill-pink-600"
                                    viewBox="0 0 64 64">
                                    <path
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="inline-block w-4 h-4 cursor-pointer fill-gray-400 hover:fill-red-600"
                                    viewBox="0 0 24 24">
                                    <path
                            ...
                            <h3 class="mt-auto text-sm font-bold text-gray-800 sm:text-base">$120.00</h3>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(61,63,68,0.3)]">
                        <div class="flex gap-4">
                            ...
                            <div class="flex flex-col gap-4">
                                <div>
                                    <h3 class="text-sm font-bold text-gray-800 sm:text-base">Stylish Smart Watch</h3>
                                    <p class="flex items-center gap-2 mt-2 text-sm font-semibold text-gray-500">Color:
                                        <span class="inline-block w-5 h-5 rounded-md bg-[#e8dcdc]"></span></p>
                                </div>
                        ...
                        <div class="flex flex-col ml-auto">
                            ...
                            <h3 class="mt-auto text-sm font-bold text-gray-800 sm:text-base">$70.00</h3>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(61,63,68,0.3)]">
                        <div class="flex gap-4">
                            ...
                            <div class="flex flex-col gap-4">
                                <div>
                                    <h3 class="text-sm font-bold text-gray-800 sm:text-base">Round Glass</h3>
                                    <p class="flex items-center gap-2 mt-2 text-sm font-semibold text-gray-500">Color:
                                        <span class="inline-block w-5 h-5 rounded-md bg-[#000]"></span></p>
                                </div>
                        ...
                        <div class="flex flex-col ml-auto">
                            ...
                            <h3 class="mt-auto text-sm font-bold text-gray-800 sm:text-base">$20.00</h3>
                        </div>
                    </div>
                </div>
