            ...
            <div class="grid gap-8 mt-16 md:grid-cols-3">
                <div class="space-y-4 md:col-span-2">
                    <div class="grid items-start grid-cols-3 gap-4">
                        ...
                        <div class="ml-auto">
                            <h4 class="text-lg font-bold text-gray-800 max-sm:text-base">$20.00</h4>
                    ...
                    <div class="grid items-start grid-cols-3 gap-4">
                        ...
                        <div class="ml-auto">
                            <h4 class="text-lg font-bold text-gray-800 max-sm:text-base">$60.00</h4>
                    ...
                    <div class="grid items-start grid-cols-3 gap-4">
                        ...
                        <div class="ml-auto">
                            <h4 class="text-lg font-bold text-gray-800 max-sm:text-base">$40.00</h4>
                ...
                <div class="p-4 bg-gray-100 rounded-md h-max">
                    <h3 class="pb-2 text-lg font-bold text-gray-800 border-b border-gray-300 max-sm:text-base">Order
                        Summary</h3>

                    <form class="mt-6">
                        <div>
                            <h3 class="mb-4 text-base font-semibold text-gray-800">Enter Details</h3>
                            <div class="space-y-3">
                                ...
                                <div class="relative flex items-center">
                                    <input type="email" placeholder="Email"
                                        class="px-4 py-2.5 bg-white text-gray-800 rounded-md w-full text-sm border-b focus:border-gray-800 outline-none" />
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb"
                                        class="absolute w-4 h-4 right-4" viewBox="0 0 682.667 682.667">
                                        <defs>
                                ...
                                <div class="relative flex items-center">
                                    <input type="number" placeholder="Phone No."
                                        class="px-4 py-2.5 bg-white text-gray-800 rounded-md w-full text-sm border-b focus:border-gray-800 outline-none" />
                                    <svg fill="#bbb" class="absolute w-4 h-4 right-4" viewBox="0 0 64 64">
                                        <path
