            ...
            <div class="max-w-xl mx-auto md:max-w-5xl">
                <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    <div class="lg:col-span-2 max-md:order-1">
                        ...
                        <p class="mt-4 text-sm text-gray-800">Complete your transaction swiftly and securely with our
                            easy-to-use payment process.</p>

                        <form class="max-w-lg mt-8">
                            <div class="grid gap-4">
                                ...
                                <div
                                    class="flex overflow-hidden bg-gray-100 border rounded-md focus-within:border-purple-500 focus-within:bg-transparent">
                            ...
                            <button type="button"
                                class="mt-8 w-40 py-3.5 text-sm bg-purple-500 text-white rounded-md hover:bg-purple-600 tracking-wide">Pay
                            </button>
                        </form>
                    </div>
                    ...
                    <div class="p-6 bg-gray-100 rounded-md">
                        ...
                        <ul class="mt-8 space-y-3 text-gray-800">
                            <li class="flex flex-wrap gap-4 text-sm">Split Sneakers <span
                                    class="ml-auto font-bold">$150.00</span></li>
                            <li class="flex flex-wrap gap-4 text-sm">Echo Elegance <span
                                    class="ml-auto font-bold">$90.00</span></li>
                            <li class="flex flex-wrap gap-4 text-sm">Tax <span class="ml-auto font-bold">$10.00</span>
                            </li>
                            <li class="flex flex-wrap gap-4 pt-4 text-sm font-bold border-t-2">Total <span
                                    class="ml-auto">$250.00</span></li>
                        </ul>
                    </div>
                </div>
            </div>
