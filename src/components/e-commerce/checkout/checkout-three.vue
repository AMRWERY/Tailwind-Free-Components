                ...
                <div class="flex-1 min-w-0 space-y-8">
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <label for="your_name"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Your name
                                </label>
                            ...
                            <div>
                                <label for="company_name"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Company name
                                </label>
                            ...
                            <div>
                                <label for="vat_number"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> VAT number
                                </label>
