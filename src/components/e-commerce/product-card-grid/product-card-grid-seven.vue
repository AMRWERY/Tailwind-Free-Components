            ...
            <div class="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 sm:gap-6">
                <div
                    ...
                    <div
                        ...
                        <div class="text-center">
                            <h3 class="text-sm font-bold text-white lg:text-base lg:text-gray-800">White Sun Glass</h3>
                            <h4 class="mt-2 text-sm font-bold text-blue-600 lg:text-base">$35.00</h4>
                        </div>

                        <div class="flex justify-center mt-4 space-x-1 max-sm:hidden">
                            <svg class="w-[14px] h-[14px] fill-[#facc15]" viewBox="0 0 14 13" fill="none"
                ...
                <div
                    ...
                    <div
                        class="absolute left-0 right-0 w-11/12 p-2 mx-auto transition-all duration-300 rounded-lg bottom-2 lg:-bottom-80 lg:group-hover:bottom-2 bg-black/60 lg:bg-white lg:p-3">
                        <div class="text-center">
                            <h3 class="text-sm font-bold text-white lg:text-base lg:text-gray-800">Echo Elegance</h3>
                            <h4 class="mt-2 text-sm font-bold text-blue-600 lg:text-base">$20.00</h4>
                        </div>
                ...
                <div
                    ...
                    <div
                        class="absolute left-0 right-0 w-11/12 p-2 mx-auto transition-all duration-300 rounded-lg bottom-2 lg:-bottom-80 lg:group-hover:bottom-2 bg-black/60 lg:bg-white lg:p-3">
                        <div class="text-center">
                            <h3 class="text-sm font-bold text-white lg:text-base lg:text-gray-800">Acer One 14 AMD</h3>
                            <h4 class="mt-2 text-sm font-bold text-blue-600 lg:text-base">$400.00</h4>
                        </div>
                ...
                <div
                    ...
                    <div
                        class="absolute left-0 right-0 w-11/12 p-2 mx-auto transition-all duration-300 rounded-lg bottom-2 lg:-bottom-80 lg:group-hover:bottom-2 bg-black/60 lg:bg-white lg:p-3">
                        <div class="text-center">
                            <h3 class="text-sm font-bold text-white lg:text-base lg:text-gray-800">Irish Cream Dream
                            </h3>
                            <h4 class="mt-2 text-sm font-bold text-blue-600 lg:text-base">$11.00</h4>
                        </div>
                ...
                <div
                    ...
                    <div
                        class="absolute left-0 right-0 w-11/12 p-2 mx-auto transition-all duration-300 rounded-lg bottom-2 lg:-bottom-80 lg:group-hover:bottom-2 bg-black/60 lg:bg-white lg:p-3">
                        <div class="text-center">
                            <h3 class="text-sm font-bold text-white lg:text-base lg:text-gray-800">Mocha Madness</h3>
                            <h4 class="mt-2 text-sm font-bold text-blue-600 lg:text-base">$10.00</h4>
                        </div>
                ...
                <div
                    ...
                    <div
                        class="absolute left-0 right-0 w-11/12 p-2 mx-auto transition-all duration-300 rounded-lg bottom-2 lg:-bottom-80 lg:group-hover:bottom-2 bg-black/60 lg:bg-white lg:p-3">
                        <div class="text-center">
                            <h3 class="text-sm font-bold text-white lg:text-base lg:text-gray-800">Black Sun Glass</h3>
                            <h4 class="mt-2 text-sm font-bold text-blue-600 lg:text-base">$70.00</h4>
                        </div>
                ...
                <div
                    ...
                    <div
                        class="absolute left-0 right-0 w-11/12 p-2 mx-auto transition-all duration-300 rounded-lg bottom-2 lg:-bottom-80 lg:group-hover:bottom-2 bg-black/60 lg:bg-white lg:p-3">
                        <div class="text-center">
                            <h3 class="text-sm font-bold text-white lg:text-base lg:text-gray-800">Urban Sneakers</h3>
                            <h4 class="mt-2 text-sm font-bold text-blue-600 lg:text-base">$20.00</h4>
                        </div>
                ...
                <div
                    ...
                    <div
                        class="absolute left-0 right-0 w-11/12 p-2 mx-auto transition-all duration-300 rounded-lg bottom-2 lg:-bottom-80 lg:group-hover:bottom-2 bg-black/60 lg:bg-white lg:p-3">
                        <div class="text-center">
                            <h3 class="text-sm font-bold text-white lg:text-base lg:text-gray-800">ASUS Vivobook 15</h3>
                            <h4 class="mt-2 text-sm font-bold text-blue-600 lg:text-base">$450.00</h4>
                        </div>
