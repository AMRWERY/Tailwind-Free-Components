<template>
    <div>
        <div class="p-4 mx-auto font-sans lg:max-w-6xl md:max-w-3xl">
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 sm:gap-6">
                <div class="flex flex-col overflow-hidden transition-all bg-white cursor-pointer hover:shadow-md">
                    <div class="w-full">
                    ...
                    <div class="flex flex-col flex-1 p-2">
                        <div class="flex-1">
                            <h5 class="text-sm font-bold text-gray-800 truncate sm:text-base">Lexicon Luxe</h5>
                            ...
                            <div class="flex flex-wrap justify-between gap-2 mt-2">
                                <div class="flex gap-2">
                                    <h6 class="text-sm font-bold text-gray-800 sm:text-base">$10</h6>
                                    <h6 class="text-sm text-gray-500 sm:text-base"><strike>$15</strike></h6>
                                </div>
                        ...
                        <div class="flex items-center gap-2 mt-4">
                            <div class="flex items-center justify-center w-12 bg-pink-100 rounded cursor-pointer hover:bg-pink-200 h-9"
                                title="Wishlist">
                ...
                <div class="flex flex-col overflow-hidden transition-all bg-white cursor-pointer hover:shadow-md">
                    ...
                    <div class="flex flex-col flex-1 p-2">
                        <div class="flex-1">
                            <h5 class="text-sm font-bold text-gray-800 truncate sm:text-base">Adjective Attire</h5>
                            <p class="mt-1 text-gray-500 truncate">Teal Green Georgette Saree with Embroidery</p>
                            <div class="flex flex-wrap justify-between gap-2 mt-2">
                                <div class="flex gap-2">
                                    <h6 class="text-sm font-bold text-gray-800 sm:text-base">$12</h6>
                                    <h6 class="text-sm text-gray-500 sm:text-base"><strike>$15</strike></h6>
                                </div>
                                <div class="flex items-center gap-0.5">
                                    <svg class="w-[14px] h-[14px] fill-blue-600" viewBox="0 0 14 13" fill="none"
                ...
                <div class="flex flex-col overflow-hidden transition-all bg-white cursor-pointer hover:shadow-md">
                    ...
                    <div class="flex flex-col flex-1 p-2">
                        <div class="flex-1">
                            <h5 class="text-sm font-bold text-gray-800 truncate sm:text-base">ThreadCraft Vibes</h5>
                            <p class="mt-1 text-gray-500 truncate">Teal Green Georgette Saree with Embroidery</p>
                            <div class="flex flex-wrap justify-between gap-2 mt-2">
                                <div class="flex gap-2">
                                    <h6 class="text-sm font-bold text-gray-800 sm:text-base">$14</h6>
                                    <h6 class="text-sm text-gray-500 sm:text-base"><strike>$15</strike></h6>
                                </div>
                                <div class="flex items-center gap-0.5">
                                    <svg class="w-[14px] h-[14px] fill-blue-600" viewBox="0 0 14 13" fill="none"
                ...
                <div class="flex flex-col overflow-hidden transition-all bg-white cursor-pointer hover:shadow-md">
                    ...
                    <div class="flex flex-col flex-1 p-2">
                        <div class="flex-1">
                            <h5 class="text-sm font-bold text-gray-800 truncate sm:text-base">Verbal Vogue Tees</h5>
                            <p class="mt-1 text-gray-500 truncate">Teal Green Georgette Saree with Embroidery</p>
                            <div class="flex flex-wrap justify-between gap-2 mt-2">
                                <div class="flex gap-2">
                                    <h6 class="text-sm font-bold text-gray-800 sm:text-base">$12</h6>
                ...
                <div class="flex flex-col overflow-hidden transition-all bg-white cursor-pointer hover:shadow-md">
                    ...
                    <div class="flex flex-col flex-1 p-2">
                        <div class="flex-1">
                            <h5 class="text-sm font-bold text-gray-800 truncate sm:text-base">Jargon Jungle</h5>
                            <p class="mt-1 text-gray-500 truncate">Teal Green Georgette Saree with Embroidery</p>
                            <div class="flex flex-wrap justify-between gap-2 mt-2">
                                <div class="flex gap-2">
                                    <h6 class="text-sm font-bold text-gray-800 sm:text-base">$15</h6>
                                    <h6 class="text-sm text-gray-500 sm:text-base"><strike>$15</strike></h6>
                                </div>
                                <div class="flex items-center gap-0.5">
                                    <svg class="w-[14px] h-[14px] fill-blue-600" viewBox="0 0 14 13" fill="none"
                ...
                <div class="flex flex-col overflow-hidden transition-all bg-white cursor-pointer hover:shadow-md">
                    ...
                    <div class="flex flex-col flex-1 p-2">
                        <div class="flex-1">
                            <h5 class="text-sm font-bold text-gray-800 truncate sm:text-base">Syllable Streetwear</h5>
                            <p class="mt-1 text-gray-500 truncate">Teal Green Georgette Saree with Embroidery</p>
                            <div class="flex flex-wrap justify-between gap-2 mt-2">
                                <div class="flex gap-2">
                                    <h6 class="text-sm font-bold text-gray-800 sm:text-base">$14</h6>
