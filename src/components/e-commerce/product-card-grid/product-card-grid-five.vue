<template>
    <div>
        <div class="font-[sans-serif] bg-white p-4 mx-auto max-w-[1400px]">
            <h2 class="mb-6 text-xl font-extrabold text-gray-800 sm:text-3xl sm:mb-8">Premium Threads</h2>
            ...
            <div class="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 sm:gap-6">
                <div class="relative overflow-hidden cursor-pointer group">
                    ...
                    <div class="relative p-4">
                        <div
                            class="absolute left-0 right-0 z-10 flex flex-wrap justify-between w-full gap-2 px-4 pt-3 transition-all duration-500 group-hover:bottom-20 lg:bottom-5 lg:opacity-0 lg:bg-white lg:group-hover:opacity-100 max-lg:bottom-20 max-lg:py-3 max-lg:bg-white/60">
                            <button type="button" title="Add to wishlist"
                                class="bg-transparent border-none outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-5 h-5 fill-gray-800"
                                    viewBox="0 0 64 64">
                                    <path
                            ...
                            <button type="button" title="Add to cart" class="bg-transparent border-none outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-5 h-5 fill-gray-800"
                                    viewBox="0 0 512 512">
                                    <path
                        ...
                        <div class="relative z-20 bg-white">
                            ...
                            <h6 class="mt-2 text-sm text-gray-600">$100.00</h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative overflow-hidden cursor-pointer group">
                    ...
                    <div class="relative p-4">
                        ...
                        <div class="relative z-20 bg-white">
                            ...
                            <h6 class="mt-2 text-sm text-gray-600">$120.00</h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative overflow-hidden cursor-pointer group">
                    ...
                    <div class="relative p-4">
                        ...
                        <div class="relative z-20 bg-white">
                            ...
                            <h6 class="mt-2 text-sm text-gray-600">$140.00</h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative overflow-hidden cursor-pointer group">
                    ...
                    <div class="relative p-4">
                        ...
                        <div class="relative z-20 bg-white">
                            ...
                            <h6 class="mt-2 text-sm text-gray-600">$150.00</h6>
                        </div>
                    </div>
                </div>
