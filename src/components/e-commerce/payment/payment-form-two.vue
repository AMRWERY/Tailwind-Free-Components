                ...
                <div class="lg:col-span-2 max-lg:order-1">
                    ...
                    <form class="max-w-lg mt-16">
                        ...
                        <div class="grid gap-4 mt-8">
                            ...
                            <div class="flex overflow-hidden bg-white border-b-2 focus-within:border-gray-800">
                ...
                <div class="p-6 bg-gray-100 rounded-md">
                    ...
                    <ul class="mt-8 space-y-4 text-gray-800">
                        ...
                        <li class="flex flex-wrap gap-4 text-sm">Echo Elegance <span
                                class="ml-auto font-bold">$200.00</span></li>
                        <li class="flex flex-wrap gap-4 text-sm">VelvetGlide Boots <span
                                class="ml-auto font-bold">$300.00</span></li>
