<template>
  <div class="flex flex-col items-center justify-center mt-32">
    <!-- Product Card -->
    <div class="flex flex-col duration-300 shadow-md cursor-pointer  w-96 hover:-translate-y-1">
      <!-- Preview -->
      <div class="relative inline h-48 group">
        ...
        <div class="absolute bottom-0 flex flex-row justify-end w-full h-16 px-3 space-x-2 transition-all duration-200 ease-in-out delay-100 opacity-0  bg-none group-hover:opacity-100 group-hover:bg-gradient-to-t from-black/20 via-gray-800/20 to-transparent">
          ...
          <button class="px-1 my-auto transition-colors duration-200 rounded-full  bg-gray-50/10 h-9 w-9 hover:bg-gray-50/20">
            <i class="text-xl text-gray-200 transition-all duration-200  mdi mdi-playlist-plus hover:text-white" title="Add to Bookmarks"></i>
          </button>

          <!-- Add to Favorites Button -->
          <button class="px-1 my-auto transition-colors duration-200 rounded-full  bg-gray-50/10 h-9 w-9 hover:bg-gray-50/20">
            <i class="p-1 text-xl text-gray-200 transition-all duration-200  mdi mdi-heart hover:text-white" title="Add to Favorites"></i>
          </button>
        </div>
      </div>
      ...
      <div class="flex flex-col p-3 bg-white rounded-b">
        ...
        <!-- Price -->
        <div class="mt-4 mb-1 text-sm font-bold text-gray-600">$23</div>
        ...
        <div class="flex flex-row mt-2">
          ...
          <div class="flex flex-col flex-auto">
            ...
            <!-- Statistic -->
            <div class="mt-1 text-gray-400 text-xxs" title="34k Downloads in this year">
              34k Downloads
            </div>
          </div>
          ...
          <div class="flex flex-row justify-end flex-auto">
            <!-- Cart Button -->
            <a
              class="flex px-3 py-2 my-auto mr-2 text-xs transition-all duration-200 border border-amber-500 group hover:bg-amber-500 rounded-xss">
              <!-- Icon -->
            ...
            <!-- Preview Link Button -->
            <a
              class="flex px-3 py-2 my-auto text-xs transition-all duration-200 border border-amber-500 group hover:bg-amber-500 rounded-xss">
              <!-- Icon -->
              <i class="delay-100 mdi mdi-eye-outline text-amber-700 group-hover:text-white"></i>

              <!-- Text -->
              <div class="ml-2 font-semibold delay-100 text-xxs text-amber-700 group-hover:text-white">
                Live Preview
              </div>
            </a>
          </div>
