            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full px-4 md:w-1/2">
                    ...
                    ">
                      ...
                      block
                      border border-blue-100
                      dark:border-transparent dark:hover:border-gray-600
                      hover:border-blue-300
                    ">
                                    <img src="https://i.postimg.cc/8zr7BpVj/long-sleeved-t-shirt-isolated-2021-08-26-17-06-58-utc-removebg-preview.png"
                                        alt="" class="object-cover w-full lg:h-32" />
                ...
                <div class="w-full px-4 md:w-1/2">
                  ...
                  ">
                    ...
                    " href="#">
                            ...
                            <div class="p-4 mb-8 border border-gray-300 dark:border-gray-700">
                                <h2 class="mb-4 text-xl font-semibold dark:text-gray-400">
                                    Real time
                                    <span class="px-2 bg-blue-500 text-gray-50">26</span> visitors
                                    right now!
                                </h2>
                                <div class="
                      mb-1
                    ...
                    ">
                                ...
                                <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-600">
                                    <div class="bg-blue-600 dark:bg-blue-400 h-2.5 rounded-full" style="width: 45%"></div>
                                </div>
                            </div>
                            <p class="
                    inline-block
                  ...
                  ">
                    ...
                    ">
                      ...
                      lg:w-11
                      hover:text-gray-50
                      dark:text-gray-200 dark:border-blue-600
