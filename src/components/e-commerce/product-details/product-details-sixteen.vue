<template>
    <div>
        <div class="max-w-2xl p-4 font-sans tracking-wide lg:max-w-6xl max-lg:mx-auto">
            <div class="grid items-start grid-cols-1 gap-8 lg:grid-cols-5">

                <div class="text-center lg:col-span-3">
                    <div
                        class="relative p-4 before:absolute before:inset-0 before:bg-black before:opacity-20 before:rounded">
                        <img src="https://readymadeui.com/images/sunglass7.webp" alt="Product"
                            class="w-full aspect-[575/418] rounded object-contain object-top" />
                    </div>

                    <div class="flex flex-wrap gap-2 mx-auto mt-2">
                        <div
                            class="relative p-1 cursor-pointer before:absolute before:inset-0 before:bg-black before:opacity-20 before:rounded">
                            <img src="https://readymadeui.com/images/sunglass1.webp" alt="Product2"
                                class="object-contain w-20 h-16" />
                        </div>
                        <div
                            class="relative p-1 cursor-pointer before:absolute before:inset-0 before:bg-black before:opacity-20 before:rounded">
                            <img src="https://readymadeui.com/images/sunglass2.webp" alt="Product3"
                                class="object-contain w-20 h-16" />
                        </div>
                        <div
                            class="relative p-1 cursor-pointer before:absolute before:inset-0 before:bg-black before:opacity-20 before:rounded">
                            <img src="https://readymadeui.com/images/sunglass3.webp" alt="Product4"
                                class="object-contain w-20 h-16" />
                        </div>
                        <div
                            class="relative p-1 cursor-pointer before:absolute before:inset-0 before:bg-black before:opacity-20 before:rounded">
                            <img src="https://readymadeui.com/images/sunglass5.webp" alt="Product5"
                                class="object-contain w-20 h-16" />
                        </div>
                        <div
                            class="relative p-1 cursor-pointer before:absolute before:inset-0 before:bg-black before:opacity-20 before:rounded">
                        ...
                        <div
                            class="relative p-1 cursor-pointer before:absolute before:inset-0 before:bg-black before:opacity-20 before:rounded">
                            <img src="https://readymadeui.com/images/sunglass7.webp" alt="Product7"
                                class="object-contain w-20 h-16" />
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-2">
                    <div class="flex flex-wrap items-start gap-4">
                        <div>
                            <h2 class="text-xl font-bold text-gray-800">White Lens Glass</h2>

                            <div class="flex mt-2 space-x-1">
                                <svg class="w-4 h-4 fill-orange-500" viewBox="0 0 14 13" fill="none"
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-4xl font-bold text-gray-800">$130</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2 mt-4">
                            <button type="button"
                                class="w-10 bg-black border-2 border-white rounded h-9 hover:border-gray-800 shrink-0"></button>
                            <button type="button"
                                class="w-10 bg-gray-500 border-2 border-white rounded h-9 hover:border-gray-800 shrink-0"></button>
                            <button type="button"
                                class="w-10 bg-red-500 border-2 border-white rounded h-9 hover:border-gray-800 shrink-0"></button>
                            <button type="button"
                                class="w-10 bg-blue-500 border-2 border-white rounded h-9 hover:border-gray-800 shrink-0"></button>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        <button type="button"
                            class="w-full px-4 py-3 text-sm font-semibold text-white bg-orange-500 rounded hover:bg-orange-600">Buy
                            now</button>
                        <button type="button"
                            class="w-full px-4 py-2.5 border border-orange-500 bg-transparent hover:bg-gray-50 text-gray-800 text-sm font-semibold rounded">Add
                            to cart</button>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-2xl mt-12">
                <h3 class="text-xl font-bold text-gray-800">Product Features</h3>

                <ul class="grid gap-3 mt-4 sm:grid-cols-2">
                    <li class="flex items-center text-sm text-gray-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17"
                            class="mr-4 bg-orange-500 fill-white rounded-full p-[3px]" viewBox="0 0 24 24">
                            <path
                ...
                <div class="mt-6">
                    ...
                    <p class="mt-4 text-sm text-gray-600">Step up your style game with our premium white lens
                        sunglasses. Crafted for both fashion and function, these sunglasses offer UV protection, a
                        stylish design, and a lightweight frame. The scratch-resistant and polarized lenses ensure
                        durability and clarity, while the comfortable fit makes them ideal for all-day wear. Elevate
                        your look with these must-have accessories for any occasion.</p>
                </div>
            </div>
        </div>
    </div>
