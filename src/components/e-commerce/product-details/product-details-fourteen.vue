    ...
    <div class="font-[sans-serif] p-4 bg-gray-100">
      <div class="max-w-xl mx-auto lg:max-w-6xl">
        <div class="grid items-start grid-cols-1 gap-8 lg:grid-cols-2 max-lg:gap-12 max-sm:gap-8">
          <div class="top-0 w-full lg:sticky">
            <div class="flex flex-col gap-4">
              ...
              <div class="w-full max-w-full p-2 overflow-auto bg-white">
                <div class="flex flex-row justify-between gap-4 shrink-0">
                  ...
                  <img src="https://readymadeui.com/images/sunscreen-img-2.webp" alt="Product2"
                    class="object-cover object-top w-16 h-16 border-b-2 border-transparent shadow-md cursor-pointer aspect-square" />
          ...
          <div class="w-full">
            <div>
              <h3 class="text-lg font-bold text-gray-800 sm:text-xl">SunProtect Sunscreen SPF</h3>
              ...
              <div class="mt-2">
                <p class="mt-1 text-sm text-gray-500">Contains Vitamin E and Green Tea Extract to protect, nourish, and
                  hydrate the skin while providing antioxidant benefits to combat free radicals and promote a healthy
                  complexion.</p>
              </div>

              <div class="flex flex-wrap items-center gap-2 mt-4">
                <p class="text-base text-gray-500"><strike>$16</strike></p>
                <h4 class="text-2xl font-bold text-purple-800 sm:text-3xl">$12</h4>
                <div class="flex py-1 px-2 bg-purple-600 font-semibold !ml-4">
                  <span class="text-sm text-white">save 10%</span>
                </div>
              </div>

              <div>
                <h4 class="mt-4 text-base font-semibold text-gray-500">Net Wt: 100G</h4>
              </div>
            </div>
            ...
            <div>
              ...
              <p class="mt-1 text-sm text-gray-500">Enter the pincode of your area to check product availability.</p>
            ...
            <div class='flex justify-between gap-4 mt-6'>
              <div class="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="inline w-8 h-8 fill-purple-600" viewBox="0 0 64 64">
                  <g data-name="Layer 2">
                    <path
                ...
                <p class='mt-3 text-xs text-gray-500 sm:text-sm'>COD available</p>
              </div>
              <div class="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="inline w-8 h-8 fill-purple-600" viewBox="0 0 100 100">
                  <path
                ...
                <p class='mt-3 text-xs text-gray-500 sm:text-sm'>15-Day Return Policy</p>
              </div>
              <div class="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="inline w-8 h-8 fill-purple-600" viewBox="0 0 32 32">
                ...
                <p class='mt-3 text-xs text-gray-500 sm:text-sm'>Free Delivery On Orders Above $100</p>
              </div>
            </div>
          </div>
        </div>
