                ...
                <div class="md:py-8">
                    ...
                    <div class="mb-4 md:mb-6">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span
                                class="w-8 h-8 transition duration-100 bg-gray-800 border rounded-full ring-2 ring-gray-800 ring-offset-1"></span>
                            <button type="button"
                                class="w-8 h-8 transition duration-100 bg-gray-500 border rounded-full ring-2 ring-transparent ring-offset-1 hover:ring-gray-200"></button>
                            <button type="button"
                                class="w-8 h-8 transition duration-100 bg-gray-200 border rounded-full ring-2 ring-transparent ring-offset-1 hover:ring-gray-200"></button>
                            <button type="button"
                                class="w-8 h-8 transition duration-100 bg-white border rounded-full ring-2 ring-transparent ring-offset-1 hover:ring-gray-200"></button>
                        </div>
                    </div>
                    <!-- color - end -->
                    ...
                    <div class="mb-8 md:mb-10">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <button type="button"
                                class="flex items-center justify-center w-12 h-8 text-sm font-semibold text-center text-gray-800 transition duration-100 bg-white border rounded-md hover:bg-gray-100 active:bg-gray-200">XS</button>
                            <button type="button"
                                class="flex items-center justify-center w-12 h-8 text-sm font-semibold text-center text-gray-800 transition duration-100 bg-white border rounded-md hover:bg-gray-100 active:bg-gray-200">S</button>
                            <span
                                class="flex items-center justify-center w-12 h-8 text-sm font-semibold text-center text-white bg-indigo-500 border border-indigo-500 rounded-md cursor-default">M</span>
                            <button type="button"
                                class="flex items-center justify-center w-12 h-8 text-sm font-semibold text-center text-gray-800 transition duration-100 bg-white border rounded-md hover:bg-gray-100 active:bg-gray-200">L</button>
                            <span
                                class="flex items-center justify-center w-12 h-8 text-sm font-semibold text-center text-gray-400 bg-white border border-transparent rounded-md cursor-not-allowed">XL</span>
                        </div>
                    </div>
                    <!-- size - end -->
                    ...
                    <div class="mt-10 md:mt-16 lg:mt-20">
                        ...
                        <p class="text-gray-500">
                            ...
                            to
                            display a sample of fonts or generate text for testing.<br /><br />
