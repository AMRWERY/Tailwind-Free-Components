        ...
        <div class="container px-4 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-12 mt-8 lg:col-gap-12 xl:col-gap-16 lg:mt-12 lg:grid-cols-5 lg:gap-16">
                ...
                <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                    ...
                    <div
                        class="flex flex-col items-center justify-between py-4 mt-10 space-y-4 border-t border-b sm:flex-row sm:space-y-0">
                        ...
                        <button type="button"
                            class="inline-flex items-center justify-center px-12 py-3 text-base font-bold text-center text-white transition-all duration-200 ease-in-out bg-gray-900 border-2 border-transparent rounded-md bg-none focus:shadow hover:bg-gray-800">
                    ...
                    <div class="border-b border-gray-300">
                        <nav class="flex gap-4">
                            ...
                            <a href="#" title=""
                                ...
                                Reviews
                                <span
                                    class="block px-2 py-px ml-2 text-xs font-bold text-gray-100 bg-gray-500 rounded-full ">
                                    1,209
                                </span>
                            </a>
                        </nav>
