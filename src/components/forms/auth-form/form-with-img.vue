    ...
    <section class="bg-white">
        <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
          ...
          ">
            ...
            py-8
            sm:px-12
            lg:col-span-7 lg:px-16 lg:py-12
            xl:col-span-6
          ">
                ...
                ">
                    ...
                    <form action="#" class="mt-8 grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" id="FirstName" name="first_name" class="
                    mt-1
                    w-full
                    rounded-md
                    border-gray-200
                  ...
                  " />
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" id="LastName" name="last_name" class="
                    mt-1
                    w-full
                    rounded-md
                    border-gray-200
                  ...
                  " />
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="password" id="PasswordConfirmation" name="password_confirmation" class="
                    mt-1
                    w-full
                    rounded-md
                    border-gray-200
