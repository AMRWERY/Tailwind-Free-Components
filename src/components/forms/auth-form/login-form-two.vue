        ...
        <div class="px-4 mx-auto max-w-screen-2xl md:px-8">
            ...
            <form class="max-w-lg mx-auto border rounded-lg">
                <div class="flex flex-col gap-4 p-4 md:p-8">
                    ...
                    <div>
                        <label for="password"
                            class="inline-block mb-2 text-sm text-gray-800 sm:text-base">Password</label>
                        <input name="password"
                            class="w-full px-3 py-2 text-gray-800 transition duration-100 border rounded outline-none bg-gray-50 ring-indigo-300 focus:ring" />
                    </div>

                    <button
                        class="block px-8 py-3 text-sm font-semibold text-center text-white transition duration-100 bg-gray-800 rounded-lg outline-none ring-gray-300 hover:bg-gray-700 focus-visible:ring active:bg-gray-600 md:text-base">Log
                        in</button>
                ...
                <div class="flex items-center justify-center p-4 bg-gray-100">
                    <p class="text-sm text-center text-gray-500">Don't have an account? <a href="#"
