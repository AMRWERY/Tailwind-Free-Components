                    ...
                    <nav class="mt-6">
                        <div>
                            ...
                            <a class="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500"
                                href="#">
                                <span class="text-left">
                                    <svg width="20" fill="currentColor" height="20" class="w-5 h-5"
                                ...
                                <div class="w-full p-4 bg-white shadow-lg rounded-2xl dark:bg-gray-700">
                                    ...
                                    <div class="block m-auto">
                                        ...
                                        <div class="w-full h-2 mt-2 bg-gray-200 rounded-full">
                                            <div
                                                class="w-1/2 h-full text-xs text-center text-white bg-purple-500 rounded-full">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="mb-4">
                                <div class="w-full p-4 bg-white shadow-lg rounded-2xl dark:bg-gray-700">
                                    ...
                                    <div class="block m-auto">
                                        ...
                                        <div class="w-full h-2 mt-2 bg-gray-200 rounded-full">
                                            <div
                                                class="w-full h-full text-xs text-center text-white bg-pink-400 rounded-full">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex items-center justify-start my-4 space-x-4">
                        ...
                        <div class="w-full sm:w-1/2 xl:w-1/3">
                            ...
                            <div class="mb-4 sm:ml-4 xl:mr-4">
                                <div class="w-full bg-white shadow-lg rounded-2xl dark:bg-gray-700">
                                    ...
                                    <div
                                        class="flex items-center justify-between px-4 py-2 text-gray-600 border-b-2 border-gray-100">
                                        <p class="flex items-center text-xs dark:text-white">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <button
                                                class="p-1 mr-4 text-sm text-gray-400 border border-gray-400 rounded">
                                                <svg width="15" height="15" fill="currentColor" viewBox="0 0 20 20">
                                                    <g fill="none">
                                                        <path
                                                            d="M17.222 8.685a1.5 1.5 0 0 1 0 2.628l-10 5.498A1.5 1.5 0 0 1 5 15.496V4.502a1.5 1.5 0 0 1 2.223-1.314l10 5.497z"
                                            ...
                                            <div class="-mx-2">
                                                <table class="w-full dark:text-white">
                                                    ...
                                                    <tr class="text-gray-400 dark:text-gray-500">
                                                        <td
                                                            class="px-2 py-3 text-center text-gray-300 md:px-3 dark:text-gray-500">
                                                            25
                                                        </td>
                                                        <td
                                                            class="px-2 py-3 text-center text-gray-300 md:px-3 dark:text-gray-500">
                                                        ...
                                                        <td
                                                            class="px-2 py-3 text-center text-gray-800 cursor-pointer md:px-3 hover:text-blue-500">
                                                            1
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                            class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">
                                                            2
                                                        </td>
                                                        <td
                                                            class="relative px-1 py-3 text-center cursor-pointer hover:text-blue-500">
                                                            3
                                                            <span
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td
                                                            class="px-2 py-3 text-center text-white cursor-pointer md:px-3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td
                                                            class="relative px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">
                                                            25
                                                            <span
