<template>
    <div class="sticky top-0 z-40">
        <div class="flex items-center justify-between w-full h-20 px-6 bg-gray-100 border-b ">
            ...
            <div class="flex">
                ...
                <div class="relative text-gray-600">
                    <input type="search" name="serch" placeholder="Search products..." class="w-full h-10 px-5 text-sm bg-white border rounded-lg xl:w-64 focus:outline-none" />
        ...
        <!-- dropdown menu -->
        <div class="absolute right-0 w-48 mr-6 text-gray-700 bg-gray-100 border border-t-0 rounded-b-lg shadow-xl bottom-10" :class="dropDownOpen ? '' : 'hidden'">
    ...
    <div class="fixed z-30 w-1/2 h-screen bg-gray-100 border-r md:w-1/3 lg:w-64 md:top-0 md:left-0 lg:block" :class="sideBarOpen ? '' : 'hidden'" id="main-nav">
        ...
        <div class="px-4 mb-4">
            ...
            <div class="flex items-center w-full h-10 pl-4 text-blue-400 bg-gray-200 rounded-lg cursor-pointer hover:bg-gray-200">
        ...
        <div class="w-full min-h-screen pl-0 bg-gray-100 lg:pl-64" :class="sideBarOpen ? 'overlay' : ''" id="main-content">
            <div class="px-4 mb-4">
