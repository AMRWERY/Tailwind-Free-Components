    ...
    <header class="bg-white">
        <div class="container mx-auto px-4 py-8 flex items-center">
            ...
            <div class="w-full max-w-xs xl:max-w-lg 2xl:max-w-2xl bg-gray-100 rounded-md hidden xl:flex items-center">
                ...
                <svg class="ml-auto h-5 px-4 text-gray-500 svg-inline--fa fa-search fa-w-16 fa-9x" aria-hidden="true"
            ...
            <nav class="contents">
                <ul class="ml-4 xl:w-48 flex items-center justify-end">
                    <li class="ml-2 lg:ml-4 relative inline-block">
                        <a class="" href="">
                            <svg class="h-9 lg:h-10 p-2 text-gray-500 svg-inline--fa fa-user fa-w-14 fa-9x"
                    ...
                    <li class="ml-2 lg:ml-4 relative inline-block">
                        <a class="" href="">
                            <div
                                ...
                                3</div>
                            <svg class="h-9 lg:h-10 p-2 text-gray-500 svg-inline--fa fa-heart fa-w-16 fa-9x"
                    ...
                    <li class="ml-2 lg:ml-4 relative inline-block">
                        <a class="" href="">
                            <div
                                class="absolute -top-1 right-0 z-10 bg-yellow-400 text-xs font-bold px-1 py-0.5 rounded-sm">
                                12</div>
                            <svg class="h-9 lg:h-10 p-2 text-gray-500 svg-inline--fa fa-shopping-cart fa-w-18 fa-9x"
