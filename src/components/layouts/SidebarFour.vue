    ...
    <nav class="
      ...
      ">
        <div class="flex flex-wrap items-center cursor-pointer">
            <img src="https://readymadeui.com/profile.webp" class="w-9 h-9 rounded-full border-2 border-white" />
            <div class="ml-4">
                <p class="text-sm text-white">John Doe</p>
                <p class="text-xs text-gray-300">johndoe23@gmail.com</p>
            </div>
        </div>
        <ul class="space-y-3 mt-10">
            ...
            ">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="currentColor"
                        class="w-[18px] h-[18px] mr-3" viewBox="0 0 682.667 682.667">
                        <defs>
