          ...
          ">
                <div class="flex flex-col flex-shrink-0">
                    ...
                    <div class="flex items-center gap-x-4 mt-12">
                        <button aria-label="instagram" class="
                  focus:outline-none
                  focus:ring-2
                  focus:ring-offset-2
                  focus:ring-gray-800
                ...
                ">
                        ...
                        <button aria-label="linked-in" class="
                  focus:outline-none
                  focus:ring-2
                  focus:ring-offset-2
                  focus:ring-gray-800
                ...
                ">
                        ...
                        <button aria-label="twitter" class="
                  focus:outline-none
                  focus:ring-2
                  focus:ring-offset-2
                  focus:ring-gray-800
                ...
                ">
                        ...
                        <button aria-label="youtube" class="
                  focus:outline-none
                  focus:ring-2
                  focus:ring-offset-2
                  focus:ring-gray-800
