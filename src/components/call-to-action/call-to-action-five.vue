<template>
    <section class="py-6 dark:bg-gray-100 dark:text-gray-900">
        <div class="container flex flex-col justify-around p-4 mx-auto text-center md:p-10 lg:flex-row">
            <div class="flex flex-col justify-center lg:text-left">
                <p class="mb-1 text-sm font-medium tracking-widest uppercase dark:text-violet-600">Hic eligendi
                    necessitatibus quod quia</p>
            ...
            <div
                ...
                <button class="inline-flex items-center px-6 py-3 rounded-lg dark:bg-violet-600 dark:text-gray-50">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        class="fill-current w-7 h-7 dark:text-gray-50">
                        <path
                ...
                <button class="inline-flex items-center px-5 py-3 rounded-lg dark:bg-violet-600 dark:text-gray-50">
