    ...
    <section class="">
        <div class="mx-auto max-w-md sm:max-w-lg md:max-w-screen-xl">
            <div class="px-4 py-8 md:px-6 md:py-12 lg:px-20">
                <h1 class="text-center text-3xl font-semibold text-gray-800 lg:text-4xl">
                ...
                <div class="mt-8 grid grid-cols-1 gap-6 md:mt-10 md:grid-cols-3 lg:gap-8">
                    <article class="bg-slate-50 p-8">
                        ...
                        <div class="mt-8 flex items-center justify-center md:mt-24">
                            <img class="" src="https://justfields.com/storage/projects/7M5rV059/06.jpg" />
                        </div>
                    </article>
                    ...
                    <article class="bg-slate-50 p-8">
                        ...
                        <div class="mt-8 flex items-center justify-center md:mt-24">
                            <img class="" src="https://justfields.com/storage/projects/7M5rV059/07.jpg" />
                        </div>
                    </article>
                    ...
                    <article class="bg-slate-50 p-8">
                        ...
                        <div class="mt-8 flex items-center justify-center md:mt-24">
                            <img src="https://justfields.com/storage/projects/7M5rV059/01.jpg" />
                        </div>
                    </article>
                </div>
              ...
              grid grid-cols-1
              gap-5
              md:mt-6 md:grid-cols-2 md:gap-6
              lg:mt-8 lg:gap-8
            ">
                    <article class="bg-slate-50 p-8">
                        <div>
                        ...
                        <div class="mt-28 flex items-center justify-center md:mt-3">
                            <img src="https://justfields.com/storage/projects/7M5rV059/03.jpg" />
                        </div>
                    </article>
                    ...
                    <article class="bg-slate-50 p-8">
                        ...
                        <div class="mt-28 flex items-center justify-center md:mt-1">
                            <img src="https://justfields.com/storage/projects/7M5rV059/T_4_front.jpg" />
                        </div>
                    </article>
                </div>
            </div>
