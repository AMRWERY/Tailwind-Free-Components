                    ...
                    " />
                        ...
                        <div class="sm:col-span-3">
                            <label for="last-name" class="block text-sm font-medium leading-6 text-gray-900">Last
                                name</label>
                            <div class="mt-2">
                                <input type="text" name="last-name" id="last-name" autocomplete="family-name" class="
                      block
                      w-full
                      rounded-md
                      border-0
                    ...
                    <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            <label for="password" class="block text-sm font-medium leading-6 text-gray-900">Current
                                Password</label>
                            <div class="mt-2">
                                <input type="password" name="password" id="password" autocomplete="password" class="
                      block
                      w-full
                      rounded-md
                      border-0
            ...
            <div class="w-full mt-4 sm:w-1/3 sm:mt-0">
                <div
                    ...
                    <div class="mt-2 text-center">
                        ...
                        <p class="text-gray-500">Agent Profile</p>
                    </div>
                    <ul class="flex items-center justify-around py-4 mt-2 text-gray-700">
                        <li class="flex flex-col items-center justify-around">
                            <svg class="w-4 text-blue-900 fill-current" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20">
                                <path
                    ...
                    <div class="p-4 mx-8 mt-2 border-t">
                        <button
                            class="block w-1/2 px-6 py-2 mx-auto font-semibold text-white bg-indigo-600 rounded-full hover:bg-indigo-500 hover:shadow-sm">
                            Follow
                        </button>
                    </div>
                </div>
