<template>
    <div class="flex flex-wrap items-center h-auto max-w-4xl mx-auto my-32  lg:h-screen lg:my-0">
        <!--Main Col-->
        <div id="profile" class="w-full mx-6 bg-white rounded-lg shadow-2xl opacity-75  lg:w-3/5 lg:rounded-l-lg lg:rounded-r-none lg:mx-0">
            ...
            "></div>
                ...
                <p class="flex items-center justify-center pt-4 text-base font-bold  lg:justify-start">
                    <svg class="h-4 pr-4 text-green-700 fill-current" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20">
                        <path
                ...
                <div class="flex flex-wrap items-center justify-between w-4/5 pb-16 mx-auto mt-6  lg:pb-0 lg:w-full">
                    <a class="link" href="#" data-tippy-content="@facebook_handle">
                        <svg class="h-6 text-gray-600 fill-current hover:text-green-700" role="img" viewBox="0 0 24 24"
                    ...
                    <a class="link" href="#" data-tippy-content="@youtube_handle">
                        <svg class="h-6 text-gray-600 fill-current hover:text-green-700" role="img"
