<template>
  <div class="relative" @mouseenter="stopAutoPlay" @mouseleave="startAutoPlay">
    ...
    <div class="absolute flex space-x-3 transform -translate-x-1/2 bottom-5 left-1/2">
      <button type="button" class="w-3 h-3 rounded-full" :class="{ 'bg-gray-500': currentIndex === 0 }"
        @click="changeSlide(0)" aria-label="Slide 1"></button>
      <button type="button" class="w-3 h-3 rounded-full" :class="{ 'bg-gray-500': currentIndex === 1 }"
        @click="changeSlide(1)" aria-label="Slide 2"></button>
      <button type="button" class="w-3 h-3 rounded-full" :class="{ 'bg-gray-500': currentIndex === 2 }"
        @click="changeSlide(2)" aria-label="Slide 3"></button>
      <button type="button" class="w-3 h-3 rounded-full" :class="{ 'bg-gray-500': currentIndex === 3 }"
        @click="changeSlide(3)" aria-label="Slide 4"></button>
    </div>
    ...
    <div class="absolute inset-y-0 left-0 flex items-center">
      <button @click="prevSlide"
        ...
        <span
          ...
          <svg class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
